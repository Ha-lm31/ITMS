...
ssimTime = 20
2. Faire changer 
entre 'up' et 'down' dans x
entre 'left' et 'right' dans y
3. Dans les variables : 'signalCoods', 'signalTimerCoods', 'vehicleCountCoods' changer
l'emnlacement le dernier coordonnée doit etre en premier
"""
